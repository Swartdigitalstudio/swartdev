...
class ScriptFilePriorityManager
{
  public static function jsFile()
  {
    ...
    return [
      'helperScript' => [
        ...
        ['priority' => 101, 'filename' => 'scrollToFld.min.js'],
  ...
  public static function validationScriptFile()
  {
    return [
  ...
  {
    $textTypeField = ['text', 'password', 'username', 'url', 'date', 'datetime-local', 'time', 'month', 'week', 'color'];
  ...
  public static function formAbandonmentNeededFiles($abandonType = null)
  {
    $files = [
      'draftButton' => [
        ['priority' => 401, 'filename' => 'saveDraftButtonEvent.js']
      ],
      'autoSave' => [
