      ...
      foreach ($podField as $pod) {
        foreach ($formFields as $field) {
          if (!empty($fieldPair->podFormField) && !empty($fieldPair->formField)) {
            ...
            } elseif ($fieldPair->formField === $field['key'] && isset($field['mul'], $field) && in_array($pod['type'], $string_types) && 'file-up' !== $field['type']) {
            ...
            } elseif ($fieldPair->formField === $field['key'] && 'file-up' === $field['type'] && 'file' === $pod['type']) {
    ...
    foreach ($post_map as $fieldPair) {
      foreach ($formFields as $field) {
        if (!empty($fieldPair->postFormField) && !empty($fieldPair->formField)) {
          ...
          } elseif ($fieldPair->formField === $field['key'] && 'file-up' === $field['type'] && '_thumbnail_id' === $fieldPair->postFormField && !empty($fieldValues[$field['key']])) {
